...
class NativeImpl implements Native {
  ...
  Future<Uint8List> generateKeypair({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_generate_keypair(port_),
      parseSuccessData: _wire2api_uint_8_list,
      constMeta: kGenerateKeypairConstMeta,
      argValues: [],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kGenerateKeypairConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
  ...
  Future<String> getAddress({required Uint8List slice, dynamic hint}) {
    var arg0 = _platform.api2wire_uint_8_list(slice);
    return _platform.executeNormal(FlutterRustBridgeTask(
