...
class NativeWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_generate_keypair(NativePortType port_);

  external dynamic /* void */ wire_get_address(
      NativePortType port_, Uint8List slice);
...
class NativeWire extends FlutterRustBridgeWasmWireBase<NativeWasmModule> {
  ...
  void wire_generate_keypair(NativePortType port_) =>
      wasmModule.wire_generate_keypair(port_);

  void wire_get_address(NativePortType port_, Uint8List slice) =>
      wasmModule.wire_get_address(port_, slice);
